...
const MenuDashboard: React.FC<MenuDashboardProps> = ({ restaurantId }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 transition-colors duration-300">
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <h1 className="text-xl font-semibold text-gray-900 dark:text-white transition-colors duration-300">Menu Management</h1>
              {menus.length > 1 && (
                <select
                  value={selectedMenu?._id || ''}
                  onChange={(e) => setSelectedMenu(menus.find(m => m._id === e.target.value) || null)}
                  className="px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors duration-300"
                >
                  {menus.map(menu => (
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-lg">
              ...
              {menus.length === 0 ? (
                <div className="p-6 text-center">
                  ...
                  <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-1 transition-colors duration-300">No menus yet</h3>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-4 transition-colors duration-300">Create your first menu to get started</p>
                  <Button 
                    size="sm" 
                    variant="primary"
                    onClick={() => {
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          console.log('Items stats clicked - Event:', e);
                          setActiveTab('items');
                        }}
                        style={{
                          padding: '8px',
                      ...
                      <button
                        ...
                        style={{ padding: '8px', border: 'none', borderRadius: '8px', backgroundColor: 'transparent', cursor: 'pointer', textAlign: 'center' }}
            ...
            {selectedMenu ? (
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="bg-yellow-100 dark:bg-yellow-900/20 p-4 rounded-lg mb-4 border border-yellow-300 dark:border-yellow-700">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      <strong>Debug:</strong> Current active tab: <code>{activeTab}</code>
                    </p>
                  ...
                  {activeTab === 'categories' && (
                    <div>
                      <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Category Management</h2>
                      <CategoryManager 
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center transition-all duration-300 hover:shadow-lg dark:hover:shadow-gray-900/30">
                <div className="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <motion.div
          ...
          className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 transition-all duration-300 hover:shadow-lg cursor-pointer hover:scale-105"
          onClick={() => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-700 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-all duration-300 hover:shadow-lg dark:hover:shadow-gray-900/30"
        >
            ...
            {recentActivity.map((activity, index) => (
              <div key={index} className="flex items-center">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 transition-colors duration-300">{activity.time}</p>
                </div>
              </div>
            ))}
          </div>
...
const SettingsTab: React.FC<SettingsTabProps> = ({ menu, currentTheme, onThemeChange }) => {
  ...
  return (
    <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                // Don't immediately update preview - wait for Save
              }}
      ...
      {/* Visibility Settings */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Visibility Options</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {Object.entries({
            ...
            <label key={key} className="flex items-center">
              <input
                type="checkbox"
                checked={menuSettings.visibility[key as keyof typeof menuSettings.visibility]}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Online Ordering</h3>
        <div className="space-y-4">
          <label className="flex items-center">
            <input
              type="checkbox"
              checked={menuSettings.ordering.enableOnlineOrdering}
              onChange={(e) => setMenuSettings(prev => ({
                ...prev,
                ordering: { ...prev.ordering, enableOnlineOrdering: e.target.checked }
              }))}
              className="w-4 h-4 text-primary-600 border-gray-300 rounded focus:ring-primary-500"
            />
            <span className="ml-2 text-sm font-medium text-gray-700">Enable Online Ordering</span>
          </label>
          
          {menuSettings.ordering.enableOnlineOrdering && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-6">
              <div>
                ...
                <input
                  type="number"
                  value={menuSettings.ordering.deliveryRadius}
                  onChange={(e) => setMenuSettings(prev => ({
                    ...prev,
                    ordering: { ...prev.ordering, deliveryRadius: Number(e.target.value) }
                  }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
              </div>
              <div>
                ...
                <input
                  type="number"
                  value={menuSettings.ordering.minOrderAmount}
                  onChange={(e) => setMenuSettings(prev => ({
                    ...prev,
                    ordering: { ...prev.ordering, minOrderAmount: Number(e.target.value) }
                  }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
              </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              type="text"
              value={menuSettings.seo.metaTitle}
              onChange={(e) => setMenuSettings(prev => ({
                ...prev,
          ...
          <div>
            ...
            <textarea
              value={menuSettings.seo.metaDescription}
              onChange={(e) => setMenuSettings(prev => ({
                ...prev,
          ...
          <div>
            ...
            <input
              type="text"
              value={menuSettings.seo.keywords}
              onChange={(e) => setMenuSettings(prev => ({
                ...prev,
          ...
          <form onSubmit={handleSubmit}>
            <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4 transition-colors duration-300">
              <div className="sm:flex sm:items-start">
                <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-primary-100 dark:bg-primary-900/30 sm:mx-0 sm:h-10 sm:w-10 transition-colors duration-300">
                  <Plus className="h-6 w-6 text-primary-600 dark:text-primary-400" aria-hidden="true" />
                </div>
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                  <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white mb-4 transition-colors duration-300">
                    Create New Menu
                  </h3>
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors duration-300"
                        required
                        disabled={loading}
                      />
                    </div>
